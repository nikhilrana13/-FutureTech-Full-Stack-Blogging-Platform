...
const Footer = () => {
    return (
        <footer className="w-full py-10 md:px-[100px] px-4 ">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <NavLink
                            to="#"
                            className="py-2.5 px-5 h-9 block w-fit bg-[#333333] rounded-full shadow-sm text-xs text-white  transition-all  duration-500 hover:bg-[#1A1A1A] hover:text-white lg:mx-0"
                        >
                            Contact us
                        </NavLink>
                    </div>
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-white font-medium mb-7">Home</h4>
                    ...
                    {/*End Col*/}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-white font-medium mb-7">News</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a
                                    href="javascript:;"
                ...
                {/*Grid*/}
                <div className="py-7 border-t border-[#7E7E81]">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">
                            ©<NavLink href="/">FutureTech</NavLink> Made with ❤️ by Nikhil Rana
